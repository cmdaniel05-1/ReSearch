...
Revision ID: 0192865607ea
Revises: 
Create Date: 2025-02-16 01:37:38.424309
...
def upgrade():
    ...
    sa.Column('faculty_responded', sa.Boolean(), nullable=False),
    sa.Column('is_accepted', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['position_id'], ['position.id'], ),
    sa.ForeignKeyConstraint(['student_id'], ['student.id'], ),
    sa.PrimaryKeyConstraint('student_id', 'position_id')
    )
