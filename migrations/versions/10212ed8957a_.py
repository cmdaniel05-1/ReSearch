...
Revision ID: 10212ed8957a
Revises: 
Create Date: 2025-02-24 14:25:05.869294
...
def upgrade():
    ...
    sa.Column('app_is_accepted', sa.Boolean(), nullable=True),
    sa.Column('statement', sa.String(length=500), nullable=False),
    sa.Column('reference_id', sa.Integer(), nullable=False),
    sa.Column('ref_is_accepted', sa.Boolean(), nullable=True),
